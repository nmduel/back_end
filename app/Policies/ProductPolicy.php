...
class ProductPolicy
{
    ...
    {
        return $user->checkPermissionAccess(config('permissions.access.product.list-product'));
    }
    ...
    {
        return $user->checkPermissionAccess(config('permissions.access.product.add-product'));
    }
